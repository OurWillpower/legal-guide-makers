  ...
  head: () => ({
    meta: [
      ...
      { title: "WIN Legal Advisors — Vision to Victory" },
      {
        name: "description",
        content:
          "WIN Legal Advisors — Corporate legal, compliance, contracts, DPDP & data privacy, IPR and regulatory advisory. Building scalable, compliant and investor-ready companies.",
      },
      { name: "author", content: "WIN Legal Advisors" },
      { property: "og:title", content: "WIN Legal Advisors — Vision to Victory" },
      {
        property: "og:description",
        content:
          "Corporate legal, compliance, contracts, DPDP, IPR and regulatory advisory for scalable, investor-ready companies.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#0f1930" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { name: "apple-mobile-web-app-title", content: "WIN Legal" },
